...
export function DashboardHome() {
  ...
  return (
    <div className="-mt-1 space-y-6 md:-mt-2">
      <motion.section
        initial={{ opacity: 0, y: 12 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.28, ease: 'easeOut' }}
        className="ui-panel hero-glow relative overflow-hidden rounded-3xl px-5 pb-5 pt-2 shadow-panel md:px-6 md:pb-6 md:pt-3"
      >
        <div className="dashboard-grid-overlay" aria-hidden />
        <div className="dashboard-market-bg" aria-hidden />
        <div className="dashboard-market-fade" aria-hidden />
        ...
        <div className="relative space-y-2 md:space-y-3">
          <div className="mx-auto max-w-4xl pt-1 text-center md:pt-2">
            ...
            <h1 className="mt-1.5 text-3xl font-semibold tracking-tight text-slate-900 dark:text-white md:mt-2 md:text-5xl">
