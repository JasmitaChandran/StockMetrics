  ...
  return (
    <header className="sticky top-0 z-40 border-b border-border/70 bg-bg/75 backdrop-blur-xl">
      <div className="mx-auto flex max-w-[1400px] flex-wrap items-center justify-between gap-3 px-4 py-3">
        <Link href="/dashboard" className="flex items-center gap-2 rounded-xl px-2 py-1 hover:bg-muted/60">
          ...
          <div>
            ...
            <div className="text-[10px] uppercase tracking-[0.18em] text-slate-500">Invest with Insight</div>
          </div>
        </Link>

        <nav className="order-3 flex w-full justify-center gap-1 rounded-2xl border border-border/60 bg-card/70 p-1 md:order-2 md:w-auto">
          {tabs.map((tab) => {
